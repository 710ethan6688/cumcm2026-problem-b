...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.52\linewidth]{images/fig_q3_seven_point_coverage.png}
    \caption{七点蜂窝全域覆盖几何构型与机器狗巡航清除实测轨迹}
...
\begin{figure}[htbp]
    \centering
    \vspace{-0.3em}
    \includegraphics[width=0.92\linewidth]{images/fig_q4_system_architecture.png}
    \vspace{-0.4em}
